  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        {/* Search Form Card */}
        <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8 mb-8 animate-fadeInUp max-w-3xl mx-auto">
            ...
            {arraydata.length > 0 ? (
              <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8">
                <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
                  ...
                  <div className="flex gap-2">
                    <span className="px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 rounded-full text-sm font-semibold capitalize">
                      {department}
                    </span>
              ...
              <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-12 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  We couldn't find any documents for <span className="font-semibold text-blue-600 capitalize">{department}</span> - <span className="font-semibold text-purple-600">Year {year}</span>
                </p>
                <button
                  onClick={() => {
                    setIsSearched(false);
