...
const Departmentpdf = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const databackget = await axios.post("https://uploadpdf2-0-1.onrender.com/user/pdf/get/department/pdf", {
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 animate-fadeInUp">
          ...
          <h1 className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-4">
            Browse by Department & Year
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Find study materials filtered by department and academic year
          </p>
        </div>

        {/* Search Form Card */}
        <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/40 p-8 mb-8 animate-fadeInUp max-w-3xl mx-auto">
            ...
            {arraydata.length > 0 ? (
              <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/40 p-8">
                <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
                  <h3 className="text-2xl font-black text-gray-800 dark:text-gray-50 flex items-center gap-2">
                    ...
                    Found {arraydata.length} {arraydata.length === 1 ? 'Document' : 'Documents'}
                  </h3>
                  <div className="flex gap-2">
                    <span className="px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-950/50 dark:to-purple-950/50 text-blue-700 dark:text-blue-400 rounded-full text-sm font-semibold capitalize">
                      {department}
                    </span>
                    <span className="px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-950/50 dark:to-pink-950/50 text-purple-700 dark:text-purple-400 rounded-full text-sm font-semibold">
                      Year {year}
                    </span>
                  </div>
                </div>
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                        ...
                        <div className="flex-1 space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2 pt-2">
                            ...
                            <span className="inline-flex items-center gap-1 px-3 py-1 bg-green-100 dark:bg-green-950/50 text-green-700 dark:text-green-400 rounded-full text-xs font-semibold capitalize">
                              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/40 p-12 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  We couldn't find any documents for <span className="font-semibold text-blue-600 dark:text-blue-400 capitalize">{department}</span> - <span className="font-semibold text-purple-600 dark:text-purple-400">Year {year}</span>
                </p>
                <button
                  onClick={() => {
                    setIsSearched(false);
