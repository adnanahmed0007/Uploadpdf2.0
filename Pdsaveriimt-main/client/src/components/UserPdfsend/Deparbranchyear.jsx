...
const Deparbranchyear = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await axios.post("http://localhost:9090/user/pdf/get/pdf", {
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-12 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all appearance-none"
                    required
                  >
          ...
          <div className="animate-fadeInUp">
            {array.length > 0 ? (
              <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8">
                <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-4 py-2 bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 rounded-full text-sm font-semibold capitalize">
                      {department}
                    </span>
                    ...
                    <span className="px-4 py-2 bg-gradient-to-r from-pink-100 to-pink-200 text-pink-700 rounded-full text-sm font-semibold">
                      Year {year}
                    </span>
                  </div>
                </div>
              ...
              <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-12 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-800 mb-3">No Documents Found</h3>
                <p className="text-gray-600 mb-6">
                  We couldn't find any documents matching your filters:
                </p>
                <div className="flex flex-wrap justify-center gap-2 mb-6">
                  <span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold capitalize">{department}</span>
                  <span className="px-4 py-2 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold uppercase">{branch}</span>
                  <span className="px-4 py-2 bg-pink-100 text-pink-700 rounded-full text-sm font-semibold">Year {year}</span>
                </div>
                <button
                  onClick={() => {
                    setIsSearched(false);
