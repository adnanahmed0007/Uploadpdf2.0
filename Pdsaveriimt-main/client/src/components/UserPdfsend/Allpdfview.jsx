  ...
  async function handleSubmit(e) {
    ...
    try {
      if (department && branch && year && FileNampdfuser) {
        const datagetback = await axios.post("http://localhost:9090/user/pdf/get/departemnt/branch/year/pdf", {
        ...
        alert("Please enter Department and File Name (required fields)");
      }
    } catch (e) {
