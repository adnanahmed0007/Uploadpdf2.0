  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        {/* Upload Form Card */}
        <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/40 p-8 mb-8 animate-fadeInUp">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="pdf-upload"
                  className="flex items-center justify-center w-full px-6 py-4 bg-gray-50 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-all duration-300 group"
                >
                  <div className="text-center">
                    <svg className="mx-auto w-12 h-12 text-gray-400 dark:text-gray-500 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                    </svg>
                    {pdfFile ? (
                      <div>
                        <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">{pdfFile.name}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">{(pdfFile.size / 1024).toFixed(2)} KB</p>
                      </div>
                    ) : (
                      <div>
                        <p className="text-sm font-semibold text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400">Click to upload PDF</p>
            ...
            {isLoading && uploadProgress > 0 && (
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-500 dark:via-purple-500 dark:to-pink-500 transition-all duration-300 rounded-full"
        ...
        {/* Success Card */}
        {dataBack && (
          <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/70 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/40 p-8 animate-fadeInUp">
            <div className="text-center space-y-6">
              {/* Success Icon */}
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-400 to-emerald-500 dark:from-green-500 dark:to-emerald-600 rounded-full shadow-lg">
              ...
              {/* Success Message */}
              <div>
                <h3 className="text-2xl font-black text-gray-800 dark:text-gray-50 mb-2">
                  Upload Successful!
                </h3>
              ...
              {/* File Info */}
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/40 dark:to-purple-950/40 rounded-2xl p-6 border border-blue-200 dark:border-blue-900/50">
                <div className="space-y-3 text-left">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-gray-600 dark:text-gray-400">File Name</p>
                      <p className="text-sm text-gray-900 dark:text-gray-100 font-medium">{dataBack.FileNampdfuser}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 dark:text-gray-100 font-medium capitalize">{dataBack.department}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-500 dark:to-emerald-500 text-white font-bold rounded-xl hover:shadow-2xl dark:hover:shadow-emerald-900/50 hover:scale-105 transition-all duration-300"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
